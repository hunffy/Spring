...
<script type="text/javascript">
	function disp_div(id,tab) {
		$(".info").hide() 				//class="info"인 모든태그를 의미, info인 태그들 숨김
		$(".tab").removeClass("select")	//클래스속성이 "tab"인 태그의 select 클래스 속성을 제거
		$("#"+id).show()				//id="minfo"인 태그부분 보여주기
...
<div id="minfo" class="info">
 ...
 <a href="password">[비밀번호수정]</a>&nbsp;
 	...
 	<c:if test="${loginUser.userid == 'admin'}">
 		<a href="../admin/list?id=${user.userid}">[회원목록]</a>&nbsp;
 	</c:if></div></body></html>